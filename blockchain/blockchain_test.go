...
func TestCalculateGasLimit(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			storageCallback := func(storage *storage.Storage) {
				h := &types.Header{
...
func TestBlockchain_CalculateBaseFee(t *testing.T) {
	...
	tests := []struct {
		...
		{6, chain.GenesisBaseFee, 20000000, 10000000, 0, 2}, // usage == target
		{6, chain.GenesisBaseFee, 20000000, 10000000, 0, 4}, // usage == target
		{6, chain.GenesisBaseFee, 20000000, 9000000, 0, 2},  // usage below target
		{6, chain.GenesisBaseFee, 20000000, 9000000, 0, 4},  // usage below target
		{6, chain.GenesisBaseFee, 20000000, 11000000, 0, 2}, // usage above target
		{6, chain.GenesisBaseFee, 20000000, 11000000, 0, 4}, // usage above target
		{6, chain.GenesisBaseFee, 20000000, 20000000, 0, 2}, // usage full
		{6, chain.GenesisBaseFee, 20000000, 20000000, 0, 4}, // usage full
		{6, chain.GenesisBaseFee, 20000000, 0, 0, 2},        // usage 0
		{6, chain.GenesisBaseFee, 20000000, 0, 0, 4},        // usage 0
	}
